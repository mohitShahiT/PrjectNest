...
const EditProfile = () => {
  ...
  // const handleFormSubmit = (event) => {
  //   event.preventDefault();
  //   console.log('Form submitted:', { username, fullName, password, about, email, image });
  // };
    ...
    <>
      ...
      <div className={styles.edit_profile_container}>
        <div className={styles.left_section}>
          ...
          <h3>Ravi Pajiyar</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos id, unde delectus amet eius nostrum rerum fugiat quaerat reiciendis at harum explicabo distinctio expedit</p>
        </div>
