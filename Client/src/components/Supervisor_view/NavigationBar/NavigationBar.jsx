  ...
  return (
    <nav className={styles.navbar}>
        <div className={styles.imglogo}>
            <a href="#logo"><img src="/image/applogo.png" alt="app-logo" /></a>
        </div>
        <div className={styles.rightsec}>
            ...
            <ul className={styles.profilesec}>
                ...
                <li><a href="#settings"><IoSettingsOutline/></a></li>
                <li><a href="#help"><FiHelpCircle/></a></li>
                <li><a href="#profile"><Profiledropdown/></a>
